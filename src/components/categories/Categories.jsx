  ...
  return (
    <section id="categories" className="mt-12 mb-0 lg:my-39 scroll-mt-[30px]">
      <div className="relative max-w-[1110px] mx-auto px-5">
        ...
        <h1 className="mb-4 md:py-8 lg:py-0 lg:mb-12 md:text-center text-black md:text-2xl lg:text-[40px] font-medium md:font-semibold leading-5 lg:leading-[44px] tracking-[-0.011em] lg:tracking-[-0.023em]">
